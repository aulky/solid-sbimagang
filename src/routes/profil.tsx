...
export default function Profil() {
  ...
  createEffect(() => {
    if (changing.result) {
      if (changing.result instanceof Error)
        showToast(changing.result.message, "error");
      ...
      <Show
        ...
        fallback={
          ...
          >
            ...
            <div
              class="skeleton"
              style="width: 130px; height: 38px; border-radius: var(--radius-md); margin-top: var(--space-4);"
            ></div>
          </div>
        }
      >
