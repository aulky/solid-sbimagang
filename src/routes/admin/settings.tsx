      ...
      <Show
        ...
        fallback={
          ...
          >
            ...
            <div
              class="skeleton"
              style="width: 150px; height: 38px; border-radius: var(--radius-md); margin-top: var(--space-4);"
            ></div>
          </div>
        }
      >
        {(data) => (
          <div class="settings-card">
            ...
            <form action={updateSystemSettings} method="post">
              ...
              <div class="form-group">
                <label for="jam-mulai-checkout">
                  Jam Mulai Check-Out (Format 24 Jam)
                </label>
                <input
