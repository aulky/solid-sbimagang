...
export default function Dashboard() {
  ...
  const monthStats = () => {
    ...
    if (!records)
      return { hadir: 0, telat: 0, izin: 0, alpha: 0, onTimeRate: 0 };
    ...
    const onTimeRate =
      totalPresent > 0 ? Math.round((hadir / totalPresent) * 100) : 0;
  ...
  return (
    <div style="text-align: left;">
      <div
        class="fade-in-up"
        style="display: flex; align-items: center; gap: var(--space-3); margin-bottom: var(--space-4); flex-wrap: wrap;"
      >
        <img
          src="/favicon.png"
          alt="Logo SIGMA"
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: var(--space-3);">
        ...
        <div
          ...
          style="border-left: 4px solid var(--color-success); flex-direction: row; align-items: center; justify-content: space-between; padding: var(--space-3) var(--space-4);"
        >
          <div>
            <div
              class="stat-value"
            ...
            <div class="stat-label" style="font-size: 13px;">
              Hadir
            </div>
          </div>
        ...
        <div
          ...
          style="border-left: 4px solid var(--color-warning); flex-direction: row; align-items: center; justify-content: space-between; padding: var(--space-3) var(--space-4);"
        >
          <div>
            <div
              class="stat-value"
        ...
        <div
          ...
          style="border-left: 4px solid var(--color-info); flex-direction: row; align-items: center; justify-content: space-between; padding: var(--space-3) var(--space-4);"
        >
          <div>
            <div
              class="stat-value"
        ...
        <div
          ...
          style="border-left: 4px solid #8b5cf6; flex-direction: row; align-items: center; justify-content: space-between; padding: var(--space-3) var(--space-4);"
        >
          <div>
            <div
              class="stat-value"
      ...
      >
        <h2 style="font-family: var(--font-headline); font-weight: 700; font-size: 1.2rem; margin-top: 0; margin-bottom: var(--space-3); color: var(--color-text);">
          Absensi Hari Ini
        </h2>
        <Show when={settings()}>
          {(s) => {
            const [tHour, tMin] = (s().jamMasuk || "08:00")
              .split(":")
              .map(Number);
            const totalMin =
              tHour * 60 + tMin + Number(s().toleransiMenit || 0);
              ...
              {(att) => (
                <div>
                  <p>
                    ...
                    {att().checkIn
                      ? new Date(att().checkIn as Date).toLocaleTimeString(
                          "id-ID",
                        )
                      : "-"}
                  </p>
        ...
        >
          <div style="background: rgba(37, 99, 235, 0.1); border-left: 4px solid var(--color-info); padding: var(--space-3) var(--space-4); border-radius: var(--radius-md); display: flex; flex-direction: column; gap: var(--space-1);">
            ...
            <p style="margin: 4px 0 0 0; font-size: 13px; color: var(--color-text-secondary); line-height: 1.4;">
              Hari ini Anda terdaftar sedang izin/sakit ({today()?.notes || "-"}
              ). Anda tidak perlu melakukan check-in atau check-out.
            </p>
          </div>
        </Show>
      </div>
